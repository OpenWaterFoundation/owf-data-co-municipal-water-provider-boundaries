...
#
# This is the old (obsolete) workflow that uses Colorado Information Marketplace datasets.
# The current workflow uses datasets from data.openwaterfoundation.org,
# which is created from DOLA datasets.
#
